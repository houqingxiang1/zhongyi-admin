    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 方剂列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="category_key" label="分类ID"></el-table-column>
...
<script>
import { getFangjiList, updateFangji, deleteFangji } from '../../api/admin';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
        ...
        // 获取 easy-mock 的模拟数据
        async getData() {
            const {data} = await getFangjiList()
            return data
        },
        // 触发搜索按钮
        async handleSearch() {
