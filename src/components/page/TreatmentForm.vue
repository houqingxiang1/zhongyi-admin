    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-calendar"></i> 方剂
                </el-breadcrumb-item>
                <el-breadcrumb-item>方剂表单</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="120px">
                    <el-form-item label="方剂名称" required>
                        <el-input v-model="form.title"></el-input>
                    </el-form-item>  
                    <el-form-item label="方剂唯一标识" required>
                        <el-input v-model="form.uni_key"></el-input>
                    </el-form-item>   
                    <el-form-item label="方剂分类ID" required>
                    ...
                    <el-form-item label="方剂描述" required>
...
<script>
import {addTreatment} from '../../api/admin'
export default {
    name: 'baseform',
    data() {
        return {            
