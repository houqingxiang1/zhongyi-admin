    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 穴位列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
import { getXueweiList, updateXuewei, deleteXuewei } from '../../api/admin';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
        ...
        // 获取 easy-mock 的模拟数据
        async getData() {
            const {data} = await getXueweiList()
            return data
        },
        // 触发搜索按钮
        async handleSearch() {
